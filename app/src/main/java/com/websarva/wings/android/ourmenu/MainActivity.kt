package com.websarva.wings.android.ourmenu
    ...
    override fun onContextItemSelected(item: MenuItem?): Boolean {
        when(item?.itemId){
            R.id.mail -> {
                ...
                val uri = Uri.fromParts("mailto","m.kpu.onecup@gmail.com",null)
            ...
            R.id.sms -> {
                val text = "${menuText.text}がたべたい！"
                val uri = Uri.fromParts("smsto","999999999999",null)
                val intent = Intent(Intent.ACTION_SENDTO,uri)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when(item?.itemId){
            ...
            R.id.peperoncino -> {
                ...
                menuText.text = getString(R.string.peperpncino_text)
            }
        }
